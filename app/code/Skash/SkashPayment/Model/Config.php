...
class Config
{
	...
	/**
	 * sKash payment status possible values
	 *
	 * @var string
	 */
	...
	public static function explainPendingReason($code)
	{
		switch ($code) {
			...
			case 'paymentreview':
				return __('The payment is pending while it is being reviewed by sKash for risk.');
			case 'unilateral':
			...
			default:
				return __('Unknown reason. Please contact sKash customer service.');
		}
	}
	...
	/**
	 * Whether a reversal/refund can be disputed with sKash
	 *
	 * @param string $code
	 *
	 * @return bool
